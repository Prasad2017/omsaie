...
class Photo {
    constructor(fileName: String?, filePath: String, isPrinted: Boolean = false, time: Long = 0L, isPhoto: Boolean = true, msg: String = "", last_row_id: String = "", count: Long) {
    ...
    fun humanDate(): String {
        return SimpleDateFormat("dd-MM-yyyy hh:mm a").format(Date(time ?: 0L))
    }
